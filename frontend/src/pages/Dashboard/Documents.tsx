...
/>
  ...
  className="w-full bg-white border border-gray-200 rounded-xl pl-10 pr-4 py-3 text-sm text-gray-700 focus:outline-none focus:border-teal-500 appearance-none transition-colors"
>
  ...
  type="submit"
  disabled={loading}
  className="w-full bg-[#006652] text-white font-semibold text-sm py-3.5 rounded-xl flex items-center justify-center gap-2 hover:bg-[#005242] transition-colors shadow-md mt-2"
>
  {loading ? "Uploading..." : "Generate AI Itinerary"}
  ...
  {!loading && (
    ...
    >
      <path
        ...
        d="M9.813 15.904 9 21l-.813-5.096L3 15.187l5.096-.813L9 9.312l.813 5.062L15 15.188l-5.187.816Zm7.938-8.914L17 10.25l-.75-3.26-3.26-.75L16.25 5.5l.75-3.26.75 3.26 3.26.75-3.26.75Z"
      />
    </svg>
  )}
</button>
...
<label className="bg-white border border-gray-200 text-xs font-semibold text-gray-700 px-6 py-2.5 rounded-full shadow-sm hover:bg-gray-50 transition-colors cursor-pointer">
  Browse Files
